...
<table class="table table-bordered table-hover">
        <tr class="badge-default">
            ...
            <th width="280px" class="text-align-center">Thao tác</th>
        </tr>
        ...
        <tr>
            ...
            <td class="align-middle text-right">
                <a class="btn btn-info mx-0 mb-1 mr-sm-1" href="{{ route('instructor-topics-show', $topic) }}">Xem</a>
                @can('topic-edit')
                <a class="btn btn-primary mx-0 mb-1 mr-sm-1" href="{{ route('instructor-topics-edit', $topic->id) }}">Sửa</a>
                @endcan
                ...
                {!! Form::open(['method' => 'DELETE',
                                ...
                                'onsubmit' => "return confirmDelete('Bạn có chắc muốn xóa đề tài \'$topic->name\' không?')"])!!}
                {!! Form::submit('Xóa', ['class' => 'btn btn-danger mx-0 mb-1 mr-sm-1']) !!}
                {!! Form::close() !!}
                @endcan
            </td>
        </tr>
